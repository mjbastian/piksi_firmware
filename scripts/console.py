...
class SwiftConsole(HasTraits):
  ...
  view = View(
    VSplit(
      Tabbed(
        ...
        Item('cw_view', style='custom', label='CW'),
        Item(
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.python_console_env.update(self.cw_view.python_console_cmds)
